...
class Collaborations extends Component {
  render() {
    return (
      <main className="collaborations-lecchain">
        <div className="collab-left-arrow-lecchain">
          <img
            width="75px"
        ...
        <div className="collab-event-lecchain">
          <div className="collab-title-lecchain">
            <h2>LOREM IPSUM</h2>
          </div>
          <div className="collab-content-lecchain">
            ...
            <div className="collab-content-text-lecchain">
        ...
        <div className="collab-right-arrow-lecchain">
          <img
            width="75px"
